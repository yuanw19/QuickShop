...
def findShortestDistance(shelf1, shelf2):
    ...
    elif (shelf1 == "entrance" and shelf2 == "A") or (shelf1 == "A" and shelf2 == "entrance"):
        return 2
    elif (shelf1 == "entrance" and shelf2 == "B") or (shelf1 == "B" and shelf2 == "entrance"):
        return 3
    elif (shelf1 == "entrance" and shelf2 == "C") or (shelf1 == "C" and shelf2 == "entrance"):
        return 7
    elif (shelf1 == "entrance" and shelf2 == "D") or (shelf1 == "D" and shelf2 == "entrance"):
        return 8
    elif (shelf1 == "entrance" and shelf2 == "E") or (shelf1 == "E" and shelf2 == "entrance"):
        return 12
    elif (shelf1 == "entrance" and shelf2 == "F") or (shelf1 == "F" and shelf2 == "entrance"):
        return 13
    elif (shelf1 == "entrance" and shelf2 == "G") or (shelf1 == "G" and shelf2 == "entrance"):
        return 17
    elif (shelf1 == "entrance" and shelf2 == "H") or (shelf1 == "H" and shelf2 == "entrance"):
        return 18
    elif (shelf1 == "entrance" and shelf2 == "I") or (shelf1 == "I" and shelf2 == "entrance"):
        return 10
    elif (shelf1 == "entrance" and shelf2 == "J") or (shelf1 == "J" and shelf2 == "entrance"):
        return 11
    elif (shelf1 == "entrance" and shelf2 == "K") or (shelf1 == "K" and shelf2 == "entrance"):
        return 13
    elif (shelf1 == "entrance" and shelf2 == "L") or (shelf1 == "L" and shelf2 == "entrance"):
        return 14
    elif (shelf1 == "entrance" and shelf2 == "M") or (shelf1 == "M" and shelf2 == "entrance"):
        return 17
    elif (shelf1 == "entrance" and shelf2 == "N") or (shelf1 == "N" and shelf2 == "entrance"):
        return 18

    elif (shelf1 == "leave" and shelf2 == "A") or (shelf1 == "A" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "B") or (shelf1 == "B" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "C") or (shelf1 == "C" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "D") or (shelf1 == "D" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "E") or (shelf1 == "E" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "F") or (shelf1 == "F" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "G") or (shelf1 == "G" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "H") or (shelf1 == "H" and shelf2 == "leave"):
        return 2
    elif (shelf1 == "leave" and shelf2 == "I") or (shelf1 == "I" and shelf2 == "leave"):
        return 10
    elif (shelf1 == "leave" and shelf2 == "J") or (shelf1 == "J" and shelf2 == "leave"):
        return 10
    elif (shelf1 == "leave" and shelf2 == "K") or (shelf1 == "K" and shelf2 == "leave"):
        return 10
    elif (shelf1 == "leave" and shelf2 == "L") or (shelf1 == "L" and shelf2 == "leave"):
        return 10
    elif (shelf1 == "leave" and shelf2 == "M") or (shelf1 == "M" and shelf2 == "leave"):
        return 10
    elif (shelf1 == "leave" and shelf2 == "N") or (shelf1 == "N" and shelf2 == "leave"):
        return 10

    elif (shelf1 == shelf2):
        return 0

    # take in a list of String typed shelves, a String typed entrance, a String typed exit,


# and return shortest path
def shortestPath(Shelves, entrance, leave):
    if len(Shelves) == 1:
        return (Shelves[0],)
    TempShelves = Shelves.copy()
    TempShelves.remove(entrance)
    if entrance != leave:
        TempShelves.remove(leave)
    Permutation = list(itertools.permutations(TempShelves))
    ShortestDis = 10000
    BestPermu = ()
    for i in range(len(Permutation)):
        ...
        dis += findShortestDistance(entrance, Permutation[i][0])
        dis += findShortestDistance(Permutation[i][-1], leave)
        if dis < ShortestDis:
            ShortestDis = dis
            BestPermu = Permutation[i]
    return (entrance,) + BestPermu + (leave,)


# a coordinate version of the above function
def shortestPath_2(coordinates, entrance, leave):
    Permutation = list(itertools.permutations(coordinates))
    ShortestDis = 10000
    BestPermu = ()
    for i in range(len(Permutation)):
        dis = 0
        for first, second in zip(Permutation[i], Permutation[i][1:]):
            dis += np.linalg.norm(first - second)
        # may need to change goods into the correct dic name
        dis += np.linalg.norm(ShelvesLoc.get(entrance) - Permutation[i][0])
        dis += np.linalg.norm(Permutation[i][-1] - ShelvesLoc.get(leave))
        if dis < ShortestDis:
            ShortestDis = dis
            BestPermu = Permutation[i]
    return BestPermu
...
# take in a list of String typed shelves, and return a dictionary of k-clustering of shelves
# and an array of cluster centers
def clustering(shelves):
    coordinates = np.array([])
    for shelf in shelves:
        # may need to change "goods" into the correct dic name
        coordinates = np.append(coordinates, ShelvesLoc.get(shelf))
    coordinates = coordinates.reshape(int(len(coordinates) / 2), 2)
    clusters = {}
    minNumberOfClusters = len(shelves) / 8
    if minNumberOfClusters <= 3:
        NumberOfClusters = 3
    else:
        NumberOfClusters = int(minNumberOfClusters) + 1
    ...
    clusterLabels = kmeans.fit_predict(coordinates)
    clusterCenters = kmeans.cluster_centers_
    for i in range(NumberOfClusters):
        key_i = 'cluster_{}'.format(i)
        clusterLocation = np.where(clusterLabels == i)[0]
        cluster = []
        for j in clusterLocation:
            cluster.append(shelves[j])
        clusters[key_i] = cluster
    return [clusters, clusterCenters]


# take in two lists of String typed shelves, and return list of two shelves
def clostestClusterPoints(cluster_1, cluster_2):
    minDis = 10000
    near_1 = ''
    near_2 = ''
    for shelf_1 in cluster_1:
        for shelf_2 in cluster_2:
            dis = findShortestDistance(shelf_1, shelf_2)
            if dis < minDis:
                minDis = dis
                near_1 = shelf_1
                near_2 = shelf_2
...
if __name__ == '__main__':
    ...
    Shelves = findShelves(goods)
    numOfShelves = len(Shelves)
    if numOfShelves <= 8:
        Shelves = ["entrance", "leave"] + Shelves
        shortPath = shortestPath(Shelves, entrance, leave)
    else:
        shortPath = ()
        clusters = clustering(Shelves)
        clusterShortPath = shortestPath_2(clusters[1], entrance, leave)
        fixedPoints = [entrance, leave]
        for i in range(len(clusterShortPath)):
            if i == 0:
                fixedPoints[1] = \
                clostestClusterPoints(clusters[0]['cluster_{}'.format(i)], clusters[0]['cluster_{}'.format(i + 1)])[0]
                shortPath += shortestPath(clusters[0]['cluster_{}'.format(i)] + ['entrance'], entrance, fixedPoints[1])
            elif i == len(clusterShortPath) - 1:
                fixedPoints[0] = \
                clostestClusterPoints(clusters[0]['cluster_{}'.format(i - 1)], clusters[0]['cluster_{}'.format(i)])[1]
                shortPath += shortestPath(clusters[0]['cluster_{}'.format(i)] + ['leave'], fixedPoints[0], leave)
            else:
                fixedPoints[0] = \
                clostestClusterPoints(clusters[0]['cluster_{}'.format(i - 1)], clusters[0]['cluster_{}'.format(i)])[1]
                fixedPoints[1] = \
                clostestClusterPoints(clusters[0]['cluster_{}'.format(i)], clusters[0]['cluster_{}'.format(i + 1)])[0]
                shortPath += shortestPath(clusters[0]['cluster_{}'.format(i)], fixedPoints[0], fixedPoints[1])
